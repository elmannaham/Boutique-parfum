    ...
    return (
      <main className="min-h-[70vh] flex items-center justify-center bg-neutral-50/50 px-4">
        <div className="text-center max-w-md bg-white p-8 rounded-3xl border border-neutral-200 shadow-sm">
          ...
          <h2 className="font-playfair text-2xl font-bold text-amber-950 mb-2">Votre panier est vide</h2>
          <p className="text-neutral-600 text-xs mb-6">Ajoutez des parfums à votre panier avant de finaliser votre commande.</p>
          <Link
            href="/products"
        ...
        <div className="max-w-xl mx-auto mb-10">
          <div className="flex items-center justify-between relative">
            ...
            <div className="relative z-10 flex flex-col items-center gap-1.5">
              ...
              <span className="text-[11px] font-semibold text-amber-950">Livraison</span>
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center gap-1.5">
              ...
              <span className="text-[11px] font-semibold text-amber-950">Paiement</span>
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center gap-1.5">
              ...
              <span className="text-[11px] font-semibold text-amber-950">Confirmation</span>
            </div>
          </div>
        </div>
        ...
        {step === 'confirmation' ? (
          ...
          >
            ...
            <p className="text-neutral-600 text-xs sm:text-sm leading-relaxed max-w-lg mx-auto mb-8">
              Un e-mail de confirmation détaillé a été envoyé à <strong>{formData.email || 'votre adresse e-mail'}</strong>.
              Nos artisans parfumeurs préparent soigneusement vos flacons et vos échantillons offerts.
            </p>
            ...
            <div className="p-4 rounded-2xl bg-amber-50/60 border border-amber-900/10 text-xs text-neutral-700 space-y-1 mb-8 max-w-md mx-auto text-left">
              <p>📍 <strong>Adresse de livraison :</strong> {formData.firstName} {formData.lastName}, {formData.street}, {formData.postalCode} {formData.city}</p>
              <p>📦 <strong>Délai estimé :</strong> 2 à 3 jours ouvrés (Colissimo Suivi)</p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-7 bg-white rounded-3xl border border-neutral-200/80 p-6 sm:p-8 shadow-sm">
              {step === 'shipping' && (
                <form onSubmit={handleShippingSubmit} className="space-y-5">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-neutral-700 mb-1.5">Adresse e-mail</label>
                    <input
                      type="email"
                      name="email"
                      required
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-semibold text-neutral-700 mb-1.5">Prénom</label>
                      <input
                        type="text"
                        name="firstName"
                        required
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-neutral-700 mb-1.5">Adresse postale</label>
                    <input
                      type="text"
                      name="street"
                      required
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-semibold text-neutral-700 mb-1.5">Code postal</label>
                      <input
                        type="text"
                        name="postalCode"
                        required
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-neutral-700 mb-1.5">Ville</label>
                      <input
                        type="text"
                        name="city"
                        required
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-neutral-700 mb-1.5">Téléphone (pour le transporteur)</label>
                    <input
                      type="tel"
                      name="phone"
              ...
              {step === 'payment' && (
                <form onSubmit={handlePaymentSubmit} className="space-y-5">
                  ...
                  <div className="p-3.5 rounded-xl bg-emerald-50/80 border border-emerald-200 flex items-center gap-3 text-xs text-emerald-800">
                    ...
                    <span>Vos informations bancaires sont transmises de manière cryptée et sécurisée.</span>
                  </div>

                  <div>
                    <label className="block text-xs font-semibold text-neutral-700 mb-1.5">Nom sur la carte</label>
                    <input
                      type="text"
                      name="cardName"
                      required
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-neutral-700 mb-1.5">Numéro de carte</label>
                    <div className="relative">
                      <CreditCard className="absolute left-3.5 top-1/2 -translate-y-1/2 text-neutral-400" size={16} />
                      <input
                        type="text"
                        name="cardNumber"
                        required
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-semibold text-neutral-700 mb-1.5">Date d'expiration</label>
                      <input
                        type="text"
                        name="cardExpiry"
                        required
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-neutral-700 mb-1.5">Cryptogramme (CVC)</label>
                      <input
                        type="text"
                        name="cardCvc"
                        required
            ...
            <div className="lg:col-span-5 bg-white rounded-3xl border border-neutral-200/80 p-6 shadow-sm space-y-5">
              <h3 className="font-playfair text-xl font-bold text-amber-950 pb-3 border-b border-neutral-100">
                Votre Commande ({items.reduce((s, i) => s + i.quantity, 0)} articles)
              </h3>
              ...
              <div className="space-y-2 text-xs text-neutral-600 border-t border-neutral-100 pt-4">
                ...
                <div className="flex justify-between">
                  <span>Livraison</span>
                  <span className={shippingInCents === 0 ? 'text-emerald-700 font-semibold' : ''}>
                    {shippingInCents === 0 ? 'Offerte' : `€${(shippingInCents / 100).toFixed(2)}`}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>TVA (20%)</span>
              ...
              <div className="pt-4 border-t border-neutral-200 flex items-baseline justify-between">
                <span className="text-sm font-bold text-amber-950">Total à payer</span>
